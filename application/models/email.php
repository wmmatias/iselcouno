...
class Email extends CI_Model {
    ...
    function creation_email($form_data, $vkey)
    { 
        //form data
        ...
        * {
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
          <tr>
            <td style="padding-right: 0px;padding-left: 0px;" align="center">
              ...
              <img align="center" border="0" src="https://iselcouno.com/images/iselco1_banner2.png" alt="Logo" title="Logo" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 44%;max-width: 255.2px;" width="255.2" class="v-src-width v-src-max-width"/>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
          <tr>
            <td style="padding-right: 0px;padding-left: 0px;" align="center">
              ...
              <img align="center" border="0" src="http://www.clker.com/cliparts/3/i/d/5/7/S/check-circle.svg.hi.png" alt="Tick Icon" title="Tick Icon" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 14%;max-width: 81.2px;" width="81.2" class="v-src-width v-src-max-width"/>
        ...
        <h1 class="v-font-size" style="margin: 0px auto; text-align:center; line-height: 160%; word-wrap: break-word; font-weight: normal; font-family: "Montserrat",sans-serif; font-size: 33px;">
            <div><strong>'.$fullname.'</strong></div>
            <div><strong>Your account has been created!</strong></div>
          </h1>
        </div>
        ...
        <table id="u_content_text_3" style="font-family:"Montserrat",sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
          ...
          <div style="color: #444444; line-height: 170%; text-align: center; word-wrap: break-word;">
            <p style="font-size: 14px; line-height: 170%;"><span style="font-size: 16px; line-height: 27.2px;">please verify that you are a valid user </span></p>
          </div>
          <div style="color: #444444; line-height: 170%; text-align: center; word-wrap: break-word;">
            <p style="font-size: 14px; line-height: 170%;"><span style="font-size: 16px; line-height: 27.2px;">password: <i>Iselco@2022</i></span></p>
            <a href="http://iselco-meter-application.local/users/verify/'.$vkey.'" target="_blank" class="v-button" style="box-sizing: border-box;display: inline-block;font-family:"Montserrat",sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #cca250; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;">
        ...
        <div align="center">
          <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://unlayer.com/" style="height:47px; v-text-anchor:middle; width:172px;" arcsize="8.5%"  stroke="f" fillcolor="#cca250"><w:anchorlock/><center style="color:#FFFFFF;font-family:"Montserrat",sans-serif;"><![endif]-->  
        ...
        <table style="font-family:"Montserrat",sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
          ...
          <div style="color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word;">
            <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 18px; line-height: 25.2px;"><strong>Iselco Uno</strong></span></p>
          </div>
        ...
        <table style="font-family:"Montserrat",sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
          ...
          <div style="color: #b0b1b4; line-height: 180%; text-align: center; word-wrap: break-word;">
            <p style="font-size: 14px; line-height: 180%;">City of Cauayan Isabela</p>
          </div>
    ...
    function resend($form_data)
    { 
        //form data
        $vkey = $form_data[0]['vkey'];
        $fullname = $form_data[0]['firstname'].' '.$form_data[0]['lastname'];
        $to = $form_data[0]['email']; 
        $subject = $this->security->xss_clean('Account Verification');
        $from = $this->security->xss_clean('iselco1main2022@gmail.com');
        $body = '
        <!DOCTYPE HTML PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
        ...
        * {
        ...
        <h1 class="v-font-size" style="margin: 0px auto; text-align:center; line-height: 160%; word-wrap: break-word; font-weight: normal; font-family: "Montserrat",sans-serif; font-size: 33px;">
            <div><strong>'.$fullname.'</strong></div>
            <div><strong>Resending your verification link</strong></div>
          </h1>
        </div>
